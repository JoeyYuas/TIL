...
//        val intent = Intent(this@LifeCycleMainActivity, LifeCycleSubActivity::class.java)
        startActivity(Intent(this@LifeCycleMainActivity, LifeCycleSubActivity::class.java))
    }
}
